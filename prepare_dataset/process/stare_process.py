...
for dataset in ['train','test']:
	img_dir = 'D:/dataset/stare/stare/image_crop/{}'.format(dataset)  # change the path to yours
	label_dir = 'D:/dataset/stare/stare/ann_crop/vk/{}'.format(dataset) # we use vk's annotation
	output_img_dir = 'D:/dataset/stare/stare/image_pad/{}'.format(dataset)
	output_label_dir = 'D:/dataset/stare/stare/ann_pad/vk/{}'.format(dataset)
