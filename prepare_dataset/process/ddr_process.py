...
for dataset in ['val','test']:
	img_dir = 'D:/dataset/ddr/DDR/image/{}_crop'.format(dataset)
	label_dir = 'D:/dataset/ddr/DDR/label/{}/ann_crop'.format(dataset)
	output_img_dir = 'D:/dataset/ddr/DDR/image/{}_pad'.format(dataset)
	output_label_dir = 'D:/dataset/ddr/DDR/label/{}/ann_pad'.format(dataset)
