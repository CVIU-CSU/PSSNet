...
for dataset in ['train','test']:
	img_dir = 'D:/dataset/idrid/A. Segmentation/image/{}_crop'.format(dataset)
	label_dir = 'D:/dataset/idrid/A. Segmentation/annotation/{}/label_crop'.format(dataset)
	output_img_dir = 'D:/dataset/idrid/A. Segmentation/image/{}_pad'.format(dataset)
	output_label_dir = 'D:/dataset/idrid/A. Segmentation/annotation/{}/label_pad'.format(dataset)
