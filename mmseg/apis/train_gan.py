...
from mmseg.core.optimizer import build_optimizers
from mmseg.core.runners.apex_amp_utils import apex_amp_initialize
...
def train_model(model,
    ...
    elif cfg.load_generator:
        runner.load_checkpoint(cfg.load_generator, load_generator=True)
