...
class Encoder_Decoder_Multi_task_group(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(Encoder_Decoder_Multi_task_group, self).__init__(init_cfg)
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        for i in range(num_out):
            N, C, H, W = x[i].shape
            x[i] = x[i].reshape(N // groups, C * groups, H, W)
            out.append(x[i])
        x = out
