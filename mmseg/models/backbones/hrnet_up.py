...
from mmseg.models.common import MyUpsampling
...
class HRNetUp(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(HRNetUp, self).__init__(init_cfg)
